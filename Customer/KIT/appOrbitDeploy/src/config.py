...
class Config():
    ...
    def loadConfig(self, fileName="local.conf"):
        ...
        try:
            ...
            self.chef_self_signed_crt = config.get('User Config', 'chef_ssl_crt')
            self.chef_self_signed_crt_dir = config.get('User Config', 'chef_ssl_crt_dir')
	    ...
	    self.domain_host = config.get('User Config', 'domain_host')
	...
	config.set('User Config', 'domain_host', domain_host)
