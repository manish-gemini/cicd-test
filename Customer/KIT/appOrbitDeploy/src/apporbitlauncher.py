...
def main():
    ...
    if os.path.isfile('/var/log/apporbit/apporbitInstall.log'): 
        os.rename('/var/log/apporbit/apporbitInstall.log','/var/log/apporbit/apporbitInstall-'+str(datetime.datetime.now().strftime('%m%d%Y%H%M%S'))+'.log') 
